...
CDTp="0.001" #p-val
FWEthreshold="0.95"
nPerms_forRandomise=1000 #5000 is recommended # *******************

# Parallelization parameters 
njobs=9 # divy permutations across njobs
first_job_to_launch=1 # for doing a subset of jobs
last_job_to_launch=9 # for doing a subset of jobs
